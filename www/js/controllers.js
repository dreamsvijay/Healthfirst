angular.module('healthyvillage.controllers', [])
.controller('WalkthroughCtrl',function($scope, $state, $templateCache, $q, $rootScope){
...
//LOGIN
.controller('PrivacyCtrl', function($scope, $state, $templateCache, $q, $rootScope) { 
